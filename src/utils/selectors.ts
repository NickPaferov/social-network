...
// auth-selectors
export const selectAuthedUserId = (state: AppRootStateType): number | null =>
  state.auth.id;
export const selectAuthStatus = (state: AppRootStateType): boolean =>
  state.auth.isAuth;
export const selectCaptchaUrl = (state: AppRootStateType): string | null =>
  state.auth.captchaUrl;
export const selectLoginError = (state: AppRootStateType): string | null =>
  state.auth.loginError;

// app-selectors
export const selectAppInitStatus = (state: AppRootStateType): boolean =>
...
// dialogs-selectors
export const selectDialogs = (state: AppRootStateType): DialogType[] =>
  state.dialogsPage.dialogs;
export const selectMessages = (state: AppRootStateType): MessageType[] =>
  state.dialogsPage.messages;

// profile-selectors
export const selectPaginationParamsLoadingStatus = (
  state: AppRootStateType
): boolean => state.usersPage.isPaginationParamsLoading;
export const selectUsersInFollowingProcess = (
  state: AppRootStateType
): number[] => state.usersPage.usersInFollowingProcess;
export const selectAuthedUserProfile = (
  state: AppRootStateType
): UserProfileResponseType | null => state.profilePage.authedUserProfile;
export const selectCurrentUserProfile = (
  state: AppRootStateType
): UserProfileResponseType | null => state.profilePage.currentUserProfile;
export const selectCurrentUserId = (
  state: AppRootStateType
): number | undefined => state.profilePage.currentUserProfile?.userId;
export const selectUserStatus = (state: AppRootStateType): string =>
...
export const selectPosts = (state: AppRootStateType): PostType[] =>
