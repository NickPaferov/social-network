...
export const usersReducer = (
  ...
  switch (action.type) {
    ...
    case "USERS/SET-IS-PAGINATION-PARAMS-LOADING-STATUS":
      return {
        ...state,
        isPaginationParamsLoading: action.isPaginationParamsLoading,
      };
    case "USERS/SET-USERS-IN-FOLLOWING-PROCESS":
      return {
        ...
        usersInFollowingProcess: action.isFollowProcessing
          ...
          : state.usersInFollowingProcess.filter(
...
export const followUserAC = (userId: number) =>
  ({ type: "USERS/FOLLOW-USER", userId } as const);
...
export const setIsPaginationParamsLoadingAC = (
  isPaginationParamsLoading: boolean
) =>
  ({
    type: "USERS/SET-IS-PAGINATION-PARAMS-LOADING-STATUS",
    isPaginationParamsLoading,
  } as const);
export const setUsersInFollowingProcessAC = (
  isFollowProcessing: boolean,
  userId: number
) =>
  ({
    type: "USERS/SET-USERS-IN-FOLLOWING-PROCESS",
    isFollowProcessing,
    userId,
  } as const);
